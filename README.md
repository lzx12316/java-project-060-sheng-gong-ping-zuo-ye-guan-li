...
本项目是 **师生共评的作业管理系统设计与实现**，采用主流 Java Web 技术栈开发，功能完整、结构清晰，非常适合作为毕业设计或课程设计的参考源码。

**仓库名**：`java-project-060-sheng-gong-ping-zuo-ye-guan-li`

**原始压缩包名**：`springboot060师生共评的作业管理系统设计与实现`
